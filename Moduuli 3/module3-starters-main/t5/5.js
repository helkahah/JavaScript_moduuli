...
for (let i=0; i<picArray.length; i++){
  ...
  head.textContent = picArray[i].title;
  //figure, eli kuvien container
  ...
  figcapt.textContent = picArray[i].caption;
  //ja viimeiseksi kuvaus
  const p = document.createElement('p');
  p.textContent = picArray[i].description;
  // tässä lajitellaan html-koodin rakenne. kaikki artikkelin sisään ohjeen mukaan
